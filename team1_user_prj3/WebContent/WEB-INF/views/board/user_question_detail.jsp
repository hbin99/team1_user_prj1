...
<div id="Cwrap" >
<div style="font-size: 30px; font-weight: bold; margin-left: 250px; ">문의사항</div>
<br>
...
<div style="clear:both;  width: 600px; height: 200px; border-bottom: 1px solid #333" id="content">
