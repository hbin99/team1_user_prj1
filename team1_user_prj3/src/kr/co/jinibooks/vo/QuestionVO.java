...
public class QuestionVO {
	...
	public String toString() {
		return "QuestionVO [num=" + num + ", id=" + id + ", subject=" + subject + ", content=" + content
				+ ", attach_file_name=" + attach_file_name + ", w_day=" + w_day + ", answer=" + answer
				+ ", answer_flag=" + answer_flag + ", admin_id=" + admin_id + "]";
	}
